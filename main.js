...
axios({
    headers: [{ "key": "Content-Type", "value": "application/json", "description": "", "type": "text", "enabled": true }],
    method: 'GET',
   ...
   for(var i = 0; i < response.data.length; i++){
    ...
    <tr>
               ...
               <td>${response.data[i].text}</td>
               <td>${response.data[i].compleato}</td>
               <td><button class="btn btn-danger" onclick='Eliminar()'> Eliminar </button></td>
            </tr>
            <tr>
               <td>${response.data[i].id}</td>
               <td>${response.data[i].text}</td>
